...
{
    internal partial class CTBankConfigPane : BankConfigPane
    {
        public CTBankConfigPane()
        {
            InitializeComponent();
        ...
        public override void SetConfig(BankConfig config)
        {
            ...
            if (chargeOnus == "Payee")
                cboChargeOnus.SelectedIndex = 0; //收款人負擔。
        ...
        public override BankConfig GetConfig()
        {
            ...
            foreach (DataGridViewRow eachRow in dgEnterpriseCode.Rows)
            {
                ...
                //string postCharge = eachRow.Cells["chPost"].Value + "";
