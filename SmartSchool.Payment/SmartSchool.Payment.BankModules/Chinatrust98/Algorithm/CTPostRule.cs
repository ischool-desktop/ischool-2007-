...
namespace AccountsReceivalbe.BuildinBank.Chinatrust98.Algorithm
{
    ...
    public class CTPostRule
    {
        ...
        public CTPostRule(VirtualAccount virtualAccount, DateTime expiredDate, decimal amount, string postCode)
        {
            this.expiredDate = expiredDate;
            this._vir_account = virtualAccount;
            this.isCheckBill = true; //一定檢查金額，目前沒有其他選項。
            this._amount = amount;
            //this.bankCode = GetBankCode(this._amount);
            this.bankCode = postCode;
        }
        ...
        {
            //金額(11)
            return Utility.GetWellFormedString(this._amount.ToString(), 11, "郵局金額不能超過11位數！");
        }
        ...
        public string GetValidationCode()
        {
            ...
            //第二次驗證
            string billString = Utility.GetWellFormedString(this._amount.ToString(), 8, "金額不能超過8位數");
