...
namespace StatisticsAndReport.DisciplineRelated
{
    public class DisciplineStatistics
    {
        ...
        {
            DisciplineRelated.SelectSemesterForm form = new DisciplineRelated.SelectSemesterForm();
        ...
        {
            SmartSchool.MotherForm.Instance.SetBarMessage("讀取學生獎懲資料中...", e.ProgressPercentage);
        }

        private void _disciplineLoader_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            SmartSchool.MotherForm.Instance.SetBarMessage("讀取完成");
