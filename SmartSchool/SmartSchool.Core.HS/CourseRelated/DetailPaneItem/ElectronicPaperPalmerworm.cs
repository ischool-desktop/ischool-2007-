...
{
    [FeatureCode("Content0215")]
    public partial class ElectronicPaperPalmerworm : PalmerwormItemBase
    {
        ...
        private void _loader_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                e.Result = Feature.ePaper.QueryElectronicPaper.GetPaperItemByViewer(ViewerType, running_id).GetContent();
            }
            catch (Exception ex)
            {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Feature.ePaper.EditElectronicPaper.DeletePaperItem(id);
            }
            catch (Exception ex)
            {
                CurrentUser.ReportError(ex);
        ...
        private void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DSXmlHelper helper = Feature.ePaper.QueryElectronicPaper.GetPaperItemContentById("" + row.Cells[colID.Index].Value).GetContent();
