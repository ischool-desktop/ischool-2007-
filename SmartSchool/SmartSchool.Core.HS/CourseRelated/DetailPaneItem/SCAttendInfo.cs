...
namespace SmartSchool.CourseRelated.DetailPaneItem
{
    ...
    internal partial class SCAttendInfo : PalmerwormItem
    {
        ...
        private void CreateStudentMenuItem()
        {
            ...
            if (Student.Instance.TemporaStudent.Count == 0)
            {
            ...
            foreach (BriefStudentData each in Student.Instance.TemporaStudent)
            {
        ...
        private void AddAddend(BriefStudentData student)
        {
            ...
            CourseInformation info = CourseEntity.Instance.FindByCourseID(int.Parse(RunningID));
        ...
        public override void Save()
        {
            ...
            try
            {
                ...
                desc.AppendLine("課程名稱：" + ((CourseInformation)CourseEntity.Instance.Items[RunningID]).CourseName+" ");
                if (insertList.Count > 0)
