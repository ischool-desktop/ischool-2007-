...
namespace SmartSchool.GovernmentalDocument.ImportExport
{
    ...
    class ExportTransferSchoolStudentsUpdateRecord : AbstractExportUpdateRecord
    {
        ...
        {
            get { return new string[] { "異動科別", "年級", "異動學號", "異動姓名", "身份證號", "性別", "生日", "異動種類", "異動代碼", "異動日期", "原因及事項", "轉入前學生資料-科別", "轉入前學生資料-年級", "轉入前學生資料-學校", "轉入前學生資料-(備查日期)", "轉入前學生資料-(備查文號)", "轉入前學生資料-學號", "核準日期", "核準文號", "備註" }; }
        }
    ...
    //class ExportTransferSchoolStudentsUpdateRecord : ExportProcess
    //{
    //    private AccessHelper _access_helper;

    //    public ExportTransferSchoolStudentsUpdateRecord()
    //    {
    ...
    //        this.Title = "匯出轉入異動";
    //        this.Group = "學籍基本資料";
    //        foreach ( string var in new string[] { "異動科別", "年級", "異動學號", "異動姓名", "身份證號", "性別", "生日", "異動種類", "異動代碼", "異動日期", "原因及事項", "轉入前學生資料-科別", "轉入前學生資料-年級", "轉入前學生資料-學校", "轉入前學生資料-(備查日期)", "轉入前學生資料-(備查文號)", "轉入前學生資料-學號",  "核準日期", "核準文號", "備註" } )
    //        {
    ...
    //            {
    //                if ( var.UpdateRecordType != "轉入異動" ) continue;
