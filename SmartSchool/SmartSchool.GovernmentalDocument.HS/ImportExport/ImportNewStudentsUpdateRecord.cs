...
namespace SmartSchool.GovernmentalDocument.ImportExport
{
    ...
    class ImportNewStudentsUpdateRecord : AbstractImportUpdateRecord
    {
        ...
        {
            get { return new string[] { "異動科別", "異動學號", "異動姓名", "身份證號", "性別", "生日", "異動代碼", "異動日期", "原因及事項", "入學資格-畢業國中", "入學資格-畢業國中所在地代碼", "核準日期", "核準文號", "備註" }; }
        }
    ...
    //class ImportNewStudentsUpdateRecord : ImportProcess
    //{
    ...
    //    public ImportNewStudentsUpdateRecord()
    //    {
    //        this.Image = null;
    //        this.Title = "匯入新生異動";
    //        this.Group = "學籍基本資料";
    ...
    //        foreach ( string field in new string[] { "異動科別", "年級", "異動學號", "異動姓名", "身份證號", "性別", "生日", "異動代碼", "異動日期", "原因及事項", "入學資格-畢業國中", "入學資格-畢業國中所在地代碼", "備註" } )
    //        {
    ...
    //            {
    //                if ( uinfo.UpdateRecordType == "新生異動" )
    //                {
    ...
    //            if ( field == "異動代碼" )
    //            {
    //                if ( updateCodeMapping.ContainsKey(e.Data[field]) == false || updateCodeMapping[e.Data[field]] != "新生異動" )
    //                {
    //                    e.ErrorFields.Add(field, "輸入的代號不在指定的新生異動代號清單中。");
    //                    continue;
    //                }
    //            }
    //            #endregion
    ...
    //    {
    //        SmartSchool.Customization.PlugIn.Global.SetStatusBarMessage("新生異動匯入完成。");
    //    }
