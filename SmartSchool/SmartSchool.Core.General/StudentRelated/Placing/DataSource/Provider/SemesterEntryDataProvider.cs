...
{
    public class SemesterEntryDataProvider : IDataProvider
    {
        ...
        public SemesterEntryDataProvider(string schoolYear, string semester, IList<string> studentidList)
        {
        ...
        void worker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            DSResponse dsrsp = SmartSchool.Feature.Score.QueryScore.GetSemesterEntryScoreForPlacing(req);
