...
{
    public class SchoolYearEntryDataProvider : IDataProvider
    {
        ...
        public SchoolYearEntryDataProvider(string schoolYear, IList<string> studentidList)
        {
        ...
        void worker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            DSResponse dsrsp = SmartSchool.Feature.Score.QueryScore.GetSchoolYearEntryScoreForPlacing(req);
