...
namespace SmartSchool.Evaluation.Reports.MultiSemesterScore
{
    class MultiSemesterScore
    {
        ...
        void bkw_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            SmartSchool.Common.MultiThreadWorker<StudentRecord> mWorker = new SmartSchool.Common.MultiThreadWorker<StudentRecord>();
            mWorker.MaxThreads = 3;
            mWorker.PackageSize = 150;
            mWorker.PackageWorker += new EventHandler<SmartSchool.Common.PackageWorkEventArgs<StudentRecord>>(mWorker_PackageWorker);
            List<SmartSchool.Common.PackageWorkEventArgs<StudentRecord>> resp = mWorker.Run(students);
            List<SmartSchool.Feature.Student.StudentSnapShop> list = new List<SmartSchool.Feature.Student.StudentSnapShop>();
            foreach (SmartSchool.Common.PackageWorkEventArgs<StudentRecord> r in resp)
            {
        ...
        void mWorker_PackageWorker(object sender, SmartSchool.Common.PackageWorkEventArgs<StudentRecord> e)
        {
        ...
        void _bgworker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            SmartSchool.Common.MultiThreadWorker<SmartSchool.Feature.Student.StudentSnapShop> mWorker = new SmartSchool.Common.MultiThreadWorker<SmartSchool.Feature.Student.StudentSnapShop>();
            mWorker.MaxThreads = 3;
            mWorker.PackageSize = 50;
            mWorker.PackageWorker += new EventHandler<SmartSchool.Common.PackageWorkEventArgs<SmartSchool.Feature.Student.StudentSnapShop>>(mWorker_PackageWorker);
        ...
        void mWorker_PackageWorker(object sender, SmartSchool.Common.PackageWorkEventArgs<SmartSchool.Feature.Student.StudentSnapShop> e)
        {
