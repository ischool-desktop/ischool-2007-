        ...
        public RetakeWithCourseList()
        {
            ...
            this.OnClick += delegate
            {
                ...
                if ( form.ShowDialog() == System.Windows.Forms.DialogResult.OK )
                {
                    ...
                    #region 下載資料
                    Common.MultiThreadBackgroundWorker<StudentRecord> dataLoader = new SmartSchool.Common.MultiThreadBackgroundWorker<StudentRecord>();
                    //dataLoader.Loading = SmartSchool.Common.MultiThreadLoading.Heavy;
                    dataLoader.PackageSize = 125;
                    dataLoader.DoWork += delegate(object sender, SmartSchool.Common.PackageDoWorkEventArgs<StudentRecord> e)
                    {
