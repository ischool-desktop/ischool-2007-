...
{
    public class ValidateGraduationPlanInfo : SmartSchool.Common.Validate.IValidater<GraduationPlanInfo>
    {
        ...
        public bool Validate(GraduationPlanInfo info, SmartSchool.Common.Validate.IErrorViewer responseViewer)
        {
            ...
            catch ( Exception ex )
            {
                ...
                SmartSchool.ExceptionHandler.BugReporter.ReportException("SmartSchool", CurrentUser.Instance.SystemVersion, ex, false);
                _OneTimeOneCheck.Set();
                return false;
            }
            return pass;
        ...
        public List<SmartSchool.Common.Validate.IValidater<GraduationPlanInfo>> ExtendValidater
        {
